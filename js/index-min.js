    ...
    new Vue({
        ...
        methods: {
            ...
            sendFriendMsg: function(t, n) {
                ...
                return this.messages.push(c), h ? (this.markMsgSize(c), setTimeout(i), r(Math.min(20 * u, 2e2)).then(function() {
           ...
           respond: function(t) {
			  ...
			  const payload = {
			    userId: userId,
			    content: t.content,
			    nextId: t.nextAuthor[0],
			    timestamp: Date.now()
			  };
			
			  console.log("🚀 payload:", payload);
			
			  fetch("http://140.143.248.88:3000/api/saveChoice", {
			    method: "POST",
			    headers: {
